...
function loadGame(loadgame) {
  ...
  unDecimalifySave()
    ...
    try {
      ...
      let style2 = game.me.unlocked ? "display:block" : "display:none"
...
function update() {
 ...
 document.getElementById("CPSCountText").innerHTML = "keke is generating " + notation.format(game.keke.cashPerSecond, 2, 1) + " cash per second <br> mutliplied by the total multiplier of " + notation.format(getTotalMultiplier(), 2, 2) + ", you are getting " + notation.format(game.cashPerSecond.multiply(getTotalMultiplier()), 2, 2)  + " cash per second."
  ...
  } else if (game.upgradesPurchased.includes("upgrade2") && game.upgradesPurchased.includes("upgrade3") && game.upgradesPurchased.includes("upgradeME")) {
    document.getElementById("BreakdownInStats").innerHTML = "keke is generating " + notation.format(game.keke.cashPerSecond, 2, 1) + " cash per second <br> mutliplied by her multiplier of " + notation.format(game.keke.multiplier, 2, 2) + ", <br> multiplied by the second upgrade's multiplier of 2, <br> multiplied by the third upgrade's multiplier of " + notation.format(game.upgrade.multiplier3, 2, 2) + ", multiplied by ME's generated multiplier of " + notation.format(game.me.totalMultiplier, 2, 2) + " <br> you are getting " + notation.format(game.cashPerSecond.multiply(getTotalMultiplier()), 2, 2)  + " cash per second."
  } else {
